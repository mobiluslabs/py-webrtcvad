...
class WebRtcVadTests(unittest.TestCase):
    ...
    def test_valid_rate_and_frame_length(self):
        self.assertTrue(webrtcvad_mob.valid_rate_and_frame_length(8000, 160))
        self.assertTrue(webrtcvad_mob.valid_rate_and_frame_length(16000, 160))
        self.assertFalse(webrtcvad_mob.valid_rate_and_frame_length(32000, 160))
        self.assertRaises(
            (ValueError, OverflowError),
            webrtcvad_mob.valid_rate_and_frame_length, 2 ** 35, 10)

    def test_process_zeroes(self):
        frame_len = 160
        self.assertTrue(
            webrtcvad_mob.valid_rate_and_frame_length(8000, frame_len))
